...
using X_WebAPI.Blazor.Server.Services;
...
using X_WebAPI.WebApi.JWT;
using DevExpress.ExpressApp.Security.Authentication;
using DevExpress.ExpressApp.Security.Authentication.ClientServer;
using DevExpress.ExpressApp.Core;
using X_WebAPI.Module.BusinessObjects;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<X_WebAPIBlazorApplication>();
            builder.Modules
                .AddAuditTrailXpo()
                ...
                .Add<X_WebAPI.Module.X_WebAPIModule>()
            	.Add<X_WebAPIBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(X_WebAPI.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(X_WebAPI.Module.BusinessObjects.ApplicationUserLoginInfo);
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "X_WebAPI API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the X_WebAPI.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
                ...
                Flows = new OpenApiOAuthFlows() {
                    AuthorizationCode = new OpenApiOAuthFlow() {
                        ...
                        Scopes = new Dictionary<string, string> {
                            ...
                            { @"[Enter the scope name in the X_WebAPI.Blazor.Server\Startup.cs file]", @"[Enter the scope description in the X_WebAPI.Blazor.Server\Startup.cs file]" }
                        }
                    }
                }
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "X_WebAPI WebApi v1");
